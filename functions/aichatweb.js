  ...
  try {
    ...
    const options = {
      ...
      data: {
        ...
        enable_memory: true, 
        input_text: "Tu es un bot IA nommé VIA qui assiste les agents de Videotron (au Québec) avec leurs questions. Tu réponds uniquement aux questions qui sont liées à la télécommunications et aux domaines connexes. Question de l'agent: " + userInput + " retourne seulement la réponse et ce avec un max de 512 caractères, pas de references, pas de liens",
      },
      timeout: 45000,
    };
